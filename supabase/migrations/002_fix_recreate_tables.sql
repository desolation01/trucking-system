...
-- Run this FIRST (it wipes the old UUID-schema tables), then run 003_seed_data.sql
-- ═══════════════════════════════════════════════════════════════════════════════

-- Drop in reverse dependency order (respects FK constraints)
DROP TABLE IF EXISTS public.payroll_ledger CASCADE;
